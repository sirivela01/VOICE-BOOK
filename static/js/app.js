import { fetchFirebaseConfig, initFirebase, isFirebaseInitialized } from "./firebase-init.js?v=2.6";
import { loginUser, registerUser, logoutUser, observeAuthState, getCurrentUser, loginWithGoogle } from "./auth.js?v=2.6";
import { createBook, getUserBooks, deleteBook, getPageContent, savePageContent, updateCurrentPage, renameBook } from "./db.js?v=2.6";
import { startListening, stopListening, isMicActive, isSpeechSupported } from "./speech.js?v=2.6";
import { initRenderer, setRenderOptions, renderText, appendText, clearPage, getPageText, renderPageStatic } from "./renderer.js?v=2.6";
import { showToast, hashString, debounce } from "./utils.js?v=2.6";
