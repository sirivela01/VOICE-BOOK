...
import { getFirebaseDb } from "./firebase-init.js?v=7.1";
import { getCurrentUser } from "./auth.js?v=7.1";

import { isGuestMode } from "./auth.js?v=7.1";
import { isFirebaseInitialized } from "./firebase-init.js?v=7.1";
