...
import { getFirebaseDb } from "./firebase-init.js?v=19.0";
import { getCurrentUser } from "./auth.js?v=19.0";

import { isGuestMode } from "./auth.js?v=19.0";
import { isFirebaseInitialized } from "./firebase-init.js?v=19.0";
