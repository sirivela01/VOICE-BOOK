...
import { getFirebaseDb } from "./firebase-init.js?v=38.0";
import { getCurrentUser, isGuestMode } from "./auth.js?v=38.0";
import { isFirebaseInitialized } from "./firebase-init.js?v=38.0";
