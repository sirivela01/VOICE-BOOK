...
import { getFirebaseDb } from "./firebase-init.js?v=6.4";
import { getCurrentUser } from "./auth.js?v=6.4";

import { isGuestMode } from "./auth.js?v=6.4";
import { isFirebaseInitialized } from "./firebase-init.js?v=6.4";
