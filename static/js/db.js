...
import { getFirebaseDb } from "./firebase-init.js?v=33.0";
import { getCurrentUser, isGuestMode } from "./auth.js?v=33.0";
import { isFirebaseInitialized } from "./firebase-init.js?v=33.0";
