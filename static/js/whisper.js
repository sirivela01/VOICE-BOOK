// OpenAI & Groq Whisper AI MediaRecorder Audio Transcription Engine
...
export async function startWhisperRecording(onStatusChange) {
    ...
    try {
        ...
        // Flush chunks every 250ms so audioChunks accumulates immediately
...
export function stopWhisperRecording(onStatusChange, onTranscribed, language = 'en') {
    ...
    mediaRecorder.onstop = async () => {
        ...
        // Validate audio chunk size (must be >= 500 bytes for a valid recording)
