// OpenAI & Groq Whisper AI High-Precision Audio Recording Engine (16kHz PCM WAV)
...
export async function startWhisperRecording(onStatusChange) {
    ...
    try {
        ...
        // 1. Try Web Audio API 16kHz PCM WAV Recording (100% compatible with Groq & OpenAI Whisper)
        ...
        // 2. Fallback to MediaRecorder (Monolithic single-blob recording, NO timeslice parameter!)
        ...
        // CRITICAL: Do NOT pass a timeslice (e.g. 250) here to prevent WebM header fragmentation
...
export function stopWhisperRecording(onStatusChange, onTranscribed, language = 'en') {
    ...
    // Build 16kHz 16-bit Mono WAV Blob
