...
def manifest():
    manifest_data = {
        ...
        "icons": [
            {
                "src": "/static/images/logo.png?v=3000.0",
                "sizes": "192x192",
                "type": "image/png",
...
def service_worker():
    sw_code = """
const CACHE_NAME = 'voicebook-v3000.0';
...
def get_config():
    config = {
        "apiKey": os.environ.get("FIREBASE_API_KEY", "AIzaSyBT1_9Pl1nUKLxlTTz8iyLX2lgIsn-m4GY"),
        ...
        "appId": os.environ.get("FIREBASE_APP_ID", "1:684418710763:web:5be1ee506cd270634092ae")
    }
    res = jsonify(config)
    res.headers['Cache-Control'] = 'no-cache, no-store, must-revalidate'
    res.headers['Access-Control-Allow-Origin'] = '*'
    return res
CURRENT_APP_VERSION = "v3000.0"
